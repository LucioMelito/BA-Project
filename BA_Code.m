...
iTotal = 4000; iCreated = 0; iter = 1;
dPowder = zeros(iTotal, 4); dStabCheck = zeros(3);
dXmax = 6; dYmax = 0.5; dZmax = 0; delta = 0.01;
% dPowder(x, y , z, r)
...
for i = 1:iTotal
    ...
    dPowder(i, 4) = normrnd(0.075, 0.025);
...
dPhoton = zeros(iNumPhotons, 9); dPhotonSpacing = 1.0/iPhotonsPerUnit; colabs = 0.05; dLaserWidth = 0.25;

% Initialise photons
for i = 1:iNumPhotons
    dPhoton(i, 1) = dPhotonSpacing * mod(i, int16(iXphotons));
